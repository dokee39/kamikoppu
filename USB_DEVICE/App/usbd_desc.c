...
#define USBD_MANUFACTURER_STRING      "dokee"
#define USBD_PID_HS                   0x606F
#define USBD_PRODUCT_STRING_HS        "dokee can<->usb test"
#define USBD_CONFIGURATION_STRING_HS  "GS_CAN Config"
#define USBD_INTERFACE_STRING_HS      "GS_CAN Interface"
...
__ALIGN_BEGIN uint8_t USBD_HS_DeviceDesc[USB_LEN_DEV_DESC] __ALIGN_END =
{
  ...
  0x00,                       /*bcdUSB */
  0x02,
  0xEF,                       /*bDeviceClass*/ // changed -> 0x02
  0x02,                       /*bDeviceSubClass*/ // changed -> 0x02
